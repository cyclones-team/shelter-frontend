...
class Hero extends react.Component {
  ...
  render() {
    return (
      <>
        <div>
        <div style={{position:"absolute",left:"55%",marginTop:"3%"}}>
            <p style={{fontSize:"220%"}}>"The Greatest Threat to Our Planet Is The Belief That Someone Else Will Save It"</p>
            <p style={{marginLeft:"65%",fontSize:"150%"}}>~Robert Swan</p>
          </div>
